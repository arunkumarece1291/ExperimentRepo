...
lblNewLabel_8 = new JLabel("DATA WAREHOUSE");
lblNewLabel_8.setFont(new Font("Tahoma", Font.BOLD, 15));
lblNewLabel_8.setBounds(34, 320, 170, 14);
...
finishbutton.addActionListener(new ActionListener() {
	public void actionPerformed(ActionEvent arg0) {
		...
		Startmatch1 am1=new Startmatch1();
		int win=totalscore+1;
		String sdd=String.valueOf(win);
		
	
	am1.textField_1.setText(sdd);	
	am1.setVisible(true);
	dispose();
	}
});
...
finishbutton.setBounds(1229, 360, 89, 23);
