...
public class Cricket_App extends JFrame implements ActionListener{
...
try {
	...
	Cricket_App frame = new Cricket_App();
...
private JLabel lblDataWarehouse;



public Cricket_App() throws InterruptedException  {
...
contentPane.add(btnNewButton);
 ...
 hatrick.addActionListener(new ActionListener() {
	...
	if(totalwicket==10) {
	 ...
	 Object bo[]= {"M Aamir",b1ballsbowled,b1dot,b1s,b1wide,b1noball,b1wicket,b1economy};
        df13.addRow(bo);
        Object bo1[]= {"Wasim Akram",b2ballsbowled,b2dot,b2s,b2wide,b2noball,b2wicket,b2economy};
        df13.addRow(bo1);
        
        Object bo2[]= {"S Akthar",b3ballsbowled,b3dot,b3s,b3wide,b3noball,b3wicket,b3economy};
        df13.addRow(bo2);
        Object bo3[]= {"S Afridi",b4ballsbowled,b4dot,b4s,b4wide,b4noball,b4wicket,b4economy};
        df13.addRow(bo3);
        Object bo4[]= {"Wahab Riaz",b5ballsbowled,b5dot,b5s,b5wide,b5noball,b5wicket,b5economy};
        df13.addRow(bo4);
	
	table_13.setModel(df13);
	
	Object ba[]= {"Rohit",p1,pb1,p1fours,p1six,srate1};
    df14.addRow(ba);
    Object ba1[]= {"V Sehwag",p2,pb2,p2fours,p2six,srate2};
    df14.addRow(ba1);
    
			
			  Object ba2[]= {"V Kohli",p3,pb3,p3fours,p3six,srate3}; df14.addRow(ba2);
			  Object ba3[]= {"S Raina",p4,pb4,p4fours,p4six,srate4}; df14.addRow(ba3);
			  Object ba4[]= {"Yuvraj",p5,pb5,p5fours,p5six,srate5}; df14.addRow(ba4);
			  Object ba5[]= {"MS Dhoni",p6,pb6,p6fours,p6six,srate6}; df14.addRow(ba5);
			  Object ba6[]= {"Kapil Dev",p7,pb7,p7fours,p7six,srate7}; df14.addRow(ba6);
			  Object ba7[]= {"Bhuvaneshkumar",p8,pb8,p8fours,p8six,srate8};
			  df14.addRow(ba7); Object ba8[]= {"R Ashwin",p9,pb9,p9fours,p9six,srate9};
			  df14.addRow(ba8); Object ba9[]= {"J Bumbrah",p10,pb10,p10fours,p10six,srate10};
			  df14.addRow(ba9); Object ba10[]= {"M Shami",p11,pb11,p11fours,p11six,srate11};
			  df14.addRow(ba10);
...
JLabel lblNewLabel_4 = new JLabel("INDIAN BATSMAN CARD");
lblNewLabel_4.setBounds(664, 47, 146, 26);
contentPane.add(lblNewLabel_4);
JLabel lblNewLabel_5 = new JLabel("PAKISTAN BOWLERS CARD");
lblNewLabel_5.setBounds(664, 378, 189, 29);
...
btnNewButton_3.addActionListener(new ActionListener() {
	public void actionPerformed(ActionEvent arg0) {
		frame.dispose();
		Startmatch1.main(new String[] {});
		
	}
});
btnNewButton_3.setBounds(1229, 360, 89, 23);
contentPane.add(btnNewButton_3);
lblDataWarehouse = new JLabel("Data WareHouse");
lblDataWarehouse.setBounds(98, 323, 122, 14);
contentPane.add(lblDataWarehouse);
ImageIcon img = new ImageIcon(this.getClass().getResource("/logoind.jpg"));



if(totalwicket==10||balltotal==120) {
	  btnNewButton_3.doClick();
}


if((balltotal==62)||(balltotal==70)||(balltotal==76)||(balltotal==82)) {
...
public void actionPerformed(ActionEvent e) {
	  ...
	  if(e.getSource()==hat) 
	{
		  ...
		  if((balltotal>59&&balltotal<=62)||(balltotal>65&&balltotal<=68)||(balltotal>71&&balltotal<=74)||(balltotal>=77&&balltotal<=80)||(balltotal>83&&balltotal<=86)||(balltotal>89&&balltotal<=92)||(balltotal>95&&balltotal<=98)||(balltotal>101&&balltotal<=104)||(balltotal>107&&balltotal<=110)||(balltotal>113&&balltotal<=116))
		  {
